...
enum {
    ...
    HOENN_DEX_XENOPH,
    HOENN_DEX_WATERDUCK,
    HOENN_DEX_WATERDUCK2,
    HOENN_DEX_WATERDUCK3,
    HOENN_DEX_GLASSEDUCK,
    HOENN_DEX_3DUCK,
    HOENN_DEX_SUNDUCK,
    HOENN_DEX_DAGGERDUCK,
    HOENN_DEX_SWORDUCK,
    HOENN_DEX_PINGEDUCK,
    HOENN_DEX_GOKUDUCK,
    HOENN_DEX_SANDUCK,
    HOENN_DEX_MONODUCK,
    HOENN_DEX_PETERDUCK,
    HOENN_DEX_INVERTDUCK,
    HOENN_DEX_PENGUIDUCK,
    HOENN_DEX_DEADUCK,
    HOENN_DEX_DUCKROLL,
    HOENN_DEX_DUCCAR,
    HOENN_DEX_BEEDUCK,
    HOENN_DEX_GHOSTEDUCK,
    HOENN_DEX_FLYINGDUCK,
    HOENN_DEX_FLYDUCK,
    HOENN_DEX_ZOMBIDUCK,
    HOENN_DEX_HELLDUCK,
    HOENN_DEX_POTDUCK,
    ...
    HOENN_DEX_DUCKBOXV5,
    HOENN_DEX_BUBCARL,
    HOENN_DEX_BUBBERDUCK,
    HOENN_DEX_ULTRABDUCK,
    HOENN_DEX_DUCKLES,
    HOENN_DEX_DUCKBOXGANG,
    HOENN_DEX_DUCKBOT666,
    HOENN_DEX_MARC,
    HOENN_DEX_BIGDUCKUS,
    HOENN_DEX_BUTTONBARI,
