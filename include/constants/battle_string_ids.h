...
#define STRINGID_ATTACKERABILITYSTATRAISE   382
#define STRINGID_PKMNSITEMREVIVED           383
#define STRINGID_BATTLERABILITYRAISEDSTAT   384
// Remember to update BATTLESTRINGS_COUNT
