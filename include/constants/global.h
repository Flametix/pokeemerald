...
#define RANDOM_ENCOUNTERS_VANILLA 0
#define RANDOM_ENCOUNTERS_SEED 1
#define RANDOM_ENCOUNTERS_PURE 2

#define RANDOM_ABILITY_VANILLA 0
#define RANDOM_ABILITY_SEED 1
#define RANDOM_ABILITY_SPECIES 2

#define RANDOM_EVOLVE_VANILLA 0
#define RANDOM_EVOLVE_SEED 1
#define RANDOM_EVOLVE_PURE 1
