...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_GRASSDUCK] = gMonIcon_Grassduck,
    [SPECIES_GRASSDUCK2] = gMonIcon_Grassduck2,
    [SPECIES_GRASSDUCK3] = gMonIcon_Grassduck3,
    [SPECIES_FLAMEDUCK] = gMonIcon_Flameduck,
    [SPECIES_FLAMEINGO] = gMonIcon_Flameingo,
    [SPECIES_XENOPH] = gMonIcon_Xenoph,
    [SPECIES_WATERDUCK] = gMonIcon_Waterduck,
    [SPECIES_WATERDUCK2] = gMonIcon_Waterduck2,
    [SPECIES_WATERDUCK3] = gMonIcon_Waterduck3,
    [SPECIES_GLASSEDUCK] = gMonIcon_Glasseduck,
    [SPECIES_3DUCK] = gMonIcon_3Duck,
    [SPECIES_SUNDUCK] = gMonIcon_Sunduck,
    [SPECIES_DAGGERDUCK] = gMonIcon_Daggerduck,
    [SPECIES_SWORDUCK] = gMonIcon_Sworduck,
    [SPECIES_PINGEDUCK] = gMonIcon_Pingeduck,
    [SPECIES_GOKUDUCK] = gMonIcon_Gokuduck,
    [SPECIES_SANDUCK] = gMonIcon_Sanduck,
    [SPECIES_MONODUCK] = gMonIcon_Monoduck,
    [SPECIES_PETERDUCK] = gMonIcon_Peterduck,
    [SPECIES_INVERTDUCK] = gMonIcon_Invertduck,
    [SPECIES_PENGUIDUCK] = gMonIcon_Penguiduck,
    [SPECIES_DEADUCK] = gMonIcon_Deaduck,
    [SPECIES_DUCCAR] = gMonIcon_Duccar,
    [SPECIES_BEEDUCK] = gMonIcon_Beeduck,
    [SPECIES_GHOSTEDUCK] = gMonIcon_Ghosteduck,
    [SPECIES_FLYINGDUCK] = gMonIcon_Flyingduck,
    [SPECIES_FLYDUCK] = gMonIcon_FlyDuck,
    [SPECIES_ZOMBIDUCK] = gMonIcon_Zombiduck,
    [SPECIES_HELLDUCK] = gMonIcon_Hellduck,
    [SPECIES_POTDUCK] = gMonIcon_Potduck,
    [SPECIES_WEEDUCK] = gMonIcon_Weeduck,
    [SPECIES_BAKEDUCK] = gMonIcon_Bakeduck,
    [SPECIES_GOLDDUCK] = gMonIcon_Goldduck,
    [SPECIES_TOXIDUCK] = gMonIcon_Toxiduck,
    [SPECIES_TETRIDUCK] = gMonIcon_Tetriduck,
    [SPECIES_VERT] = gMonIcon_Vert,
    [SPECIES_DUCKBOXV1] = gMonIcon_DuckBoxV1,
    [SPECIES_DUCKBOXV2] = gMonIcon_DuckBoxV2,
    [SPECIES_DUCKBOXV3] = gMonIcon_DuckBoxV3,
    [SPECIES_DUCKBOXV4] = gMonIcon_DuckBoxV4,
    [SPECIES_DUCKBOXV5] = gMonIcon_DuckBoxV5,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_CHIMECHO] = 0,
    [SPECIES_GRASSDUCK] = 0,
    [SPECIES_GRASSDUCK2] = 0,
    [SPECIES_GRASSDUCK3] = 0,
    [SPECIES_FLAMEDUCK] = 0,
    [SPECIES_FLAMEINGO] = 0,
    [SPECIES_XENOPH] = 0,
    [SPECIES_WATERDUCK] = 0,
    [SPECIES_WATERDUCK2] = 0,
    [SPECIES_WATERDUCK3] = 0,
    [SPECIES_GLASSEDUCK] = 0,
    [SPECIES_3DUCK] = 0,
    [SPECIES_SUNDUCK] = 0,
    [SPECIES_DAGGERDUCK] = 0,
    [SPECIES_SWORDUCK] = 0,
    [SPECIES_PINGEDUCK] = 0,
    [SPECIES_GOKUDUCK] = 0,
    [SPECIES_SANDUCK] = 0,
    [SPECIES_MONODUCK] = 0,
    [SPECIES_PETERDUCK] = 0,
    [SPECIES_INVERTDUCK] = 0,
    [SPECIES_PENGUIDUCK] = 0,
    [SPECIES_DEADUCK] = 0,
    [SPECIES_DUCCAR] = 0,
    [SPECIES_BEEDUCK] = 0,
    [SPECIES_GHOSTEDUCK] = 0,
    [SPECIES_FLYINGDUCK] = 0,
    [SPECIES_FLYDUCK] = 0,
    [SPECIES_ZOMBIDUCK] = 0,
    [SPECIES_HELLDUCK] = 0,
    [SPECIES_POTDUCK] = 0,
