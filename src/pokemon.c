...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(LEAFDUCK),
    SPECIES_TO_HOENN(LEAFDUCK2),
    SPECIES_TO_HOENN(LEAFDUCK3),
    SPECIES_TO_HOENN(FLAMEDUCK),
    SPECIES_TO_HOENN(FLAMEINGO),
    SPECIES_TO_HOENN(XENOPH),
    SPECIES_TO_HOENN(WATERDUCK),
    SPECIES_TO_HOENN(WATERDUCK2),
    SPECIES_TO_HOENN(WATERDUCK3),
    SPECIES_TO_HOENN(GLASSEDUCK),
    SPECIES_TO_HOENN(3DUCK),
    SPECIES_TO_HOENN(SUNDUCK),
    SPECIES_TO_HOENN(DAGGERDUCK),
    SPECIES_TO_HOENN(SWORDUCK),
    SPECIES_TO_HOENN(PINGEDUCK),
    SPECIES_TO_HOENN(GOKUDUCK),
    SPECIES_TO_HOENN(SANDUCK),
    SPECIES_TO_HOENN(MONODUCK),
    SPECIES_TO_HOENN(PETERDUCK),
    SPECIES_TO_HOENN(INVERTDUCK),
    SPECIES_TO_HOENN(PENGUIDUCK),
    SPECIES_TO_HOENN(DEADUCK),
    SPECIES_TO_HOENN(DUCCAR),
    SPECIES_TO_HOENN(BEEDUCK),
    SPECIES_TO_HOENN(GHOSTEDUCK),
    SPECIES_TO_HOENN(FLYINGDUCK),
    SPECIES_TO_HOENN(FLYDUCK),
    SPECIES_TO_HOENN(ZOMBIDUCK),
    SPECIES_TO_HOENN(HELLDUCK),
    SPECIES_TO_HOENN(POTDUCK),
    SPECIES_TO_HOENN(WEEDUCK),
    SPECIES_TO_HOENN(BAKEDUCK),
    SPECIES_TO_HOENN(GOLDDUCK),
    SPECIES_TO_HOENN(TOXIDUCK),
    SPECIES_TO_HOENN(TETRIDUCK),
    SPECIES_TO_HOENN(VERT),
    SPECIES_TO_HOENN(DUCKBOXV1),
    SPECIES_TO_HOENN(DUCKBOXV2),
    SPECIES_TO_HOENN(DUCKBOXV3),
    SPECIES_TO_HOENN(DUCKBOXV4),
    SPECIES_TO_HOENN(DUCKBOXV5),
    SPECIES_TO_HOENN(BUBCARL),
    SPECIES_TO_HOENN(BUBBERDUCK),
    SPECIES_TO_HOENN(ULTRABDUCK),
    SPECIES_TO_HOENN(DUCKLES),
    SPECIES_TO_HOENN(DUCKBOXGANG),
    SPECIES_TO_HOENN(DUCKBOT666),
    SPECIES_TO_HOENN(MARC),
    SPECIES_TO_HOENN(BIGDUCKUS),
    SPECIES_TO_HOENN(BUTTONBARI),
    SPECIES_TO_HOENN(DUCKROLL),
    SPECIES_TO_HOENN(FARFETCHD_GALAR),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(LEAFDUCK),
    SPECIES_TO_NATIONAL(LEAFDUCK2),
    SPECIES_TO_NATIONAL(LEAFDUCK3),
    SPECIES_TO_NATIONAL(FLAMEDUCK),
    SPECIES_TO_NATIONAL(FLAMEINGO),
    SPECIES_TO_NATIONAL(XENOPH),
    SPECIES_TO_NATIONAL(WATERDUCK),
    SPECIES_TO_NATIONAL(WATERDUCK2),
    SPECIES_TO_NATIONAL(WATERDUCK3),
    SPECIES_TO_NATIONAL(GLASSEDUCK),
    SPECIES_TO_NATIONAL(3DUCK),
    SPECIES_TO_NATIONAL(SUNDUCK),
    SPECIES_TO_NATIONAL(DAGGERDUCK),
    SPECIES_TO_NATIONAL(SWORDUCK),
    SPECIES_TO_NATIONAL(PINGEDUCK),
    SPECIES_TO_NATIONAL(GOKUDUCK),
    SPECIES_TO_NATIONAL(SANDUCK),
    SPECIES_TO_NATIONAL(MONODUCK),
    SPECIES_TO_NATIONAL(PETERDUCK),
    SPECIES_TO_NATIONAL(INVERTDUCK),
    SPECIES_TO_NATIONAL(PENGUIDUCK),
    SPECIES_TO_NATIONAL(DEADUCK),
    SPECIES_TO_NATIONAL(DUCCAR),
    SPECIES_TO_NATIONAL(BEEDUCK),
    SPECIES_TO_NATIONAL(GHOSTEDUCK),
    SPECIES_TO_NATIONAL(FLYINGDUCK),
    SPECIES_TO_NATIONAL(FLYDUCK),
    SPECIES_TO_NATIONAL(ZOMBIDUCK),
    SPECIES_TO_NATIONAL(HELLDUCK),
    SPECIES_TO_NATIONAL(POTDUCK),
    SPECIES_TO_NATIONAL(WEEDUCK),
    SPECIES_TO_NATIONAL(BAKEDUCK),
    SPECIES_TO_NATIONAL(GOLDDUCK),
    SPECIES_TO_NATIONAL(TOXIDUCK),
    SPECIES_TO_NATIONAL(TETRIDUCK),
    SPECIES_TO_NATIONAL(VERT),
    SPECIES_TO_NATIONAL(DUCKBOXV1),
    SPECIES_TO_NATIONAL(DUCKBOXV2),
    SPECIES_TO_NATIONAL(DUCKBOXV3),
    SPECIES_TO_NATIONAL(DUCKBOXV4),
    SPECIES_TO_NATIONAL(DUCKBOXV5),
    SPECIES_TO_NATIONAL(BUBCARL),
    SPECIES_TO_NATIONAL(BUBBERDUCK),
    SPECIES_TO_NATIONAL(ULTRABDUCK),
    SPECIES_TO_NATIONAL(DUCKROLL),
    SPECIES_TO_NATIONAL(AVALUGG),
    SPECIES_TO_NATIONAL(SIRFETCHD),
    SPECIES_TO_NATIONAL(FARFETCHD_GALAR),
    SPECIES_TO_NATIONAL(DUCKLES),
    SPECIES_TO_NATIONAL(DUCKBOXGANG),
    SPECIES_TO_NATIONAL(DUCKBOT666),
    SPECIES_TO_NATIONAL(MARC),
    SPECIES_TO_NATIONAL(BIGDUCKUS),
    SPECIES_TO_NATIONAL(BUTTONBARI),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(LEAFDUCK),
    HOENN_TO_NATIONAL(LEAFDUCK2),
    HOENN_TO_NATIONAL(LEAFDUCK3),
    HOENN_TO_NATIONAL(FLAMEDUCK),
    HOENN_TO_NATIONAL(FLAMEINGO),
    HOENN_TO_NATIONAL(XENOPH),
    HOENN_TO_NATIONAL(WATERDUCK),
    HOENN_TO_NATIONAL(WATERDUCK2),
    HOENN_TO_NATIONAL(WATERDUCK3),
    HOENN_TO_NATIONAL(GLASSEDUCK),
    HOENN_TO_NATIONAL(3DUCK),
    HOENN_TO_NATIONAL(SUNDUCK),
    HOENN_TO_NATIONAL(DAGGERDUCK),
    HOENN_TO_NATIONAL(SWORDUCK),
    HOENN_TO_NATIONAL(PINGEDUCK),
    HOENN_TO_NATIONAL(GOKUDUCK),
    HOENN_TO_NATIONAL(SANDUCK),
    HOENN_TO_NATIONAL(MONODUCK),
    HOENN_TO_NATIONAL(PETERDUCK),
    HOENN_TO_NATIONAL(INVERTDUCK),
    HOENN_TO_NATIONAL(PENGUIDUCK),
    HOENN_TO_NATIONAL(DEADUCK),
    HOENN_TO_NATIONAL(DUCCAR),
    HOENN_TO_NATIONAL(BEEDUCK),
    HOENN_TO_NATIONAL(GHOSTEDUCK),
    HOENN_TO_NATIONAL(FLYINGDUCK),
    HOENN_TO_NATIONAL(FLYDUCK),
    HOENN_TO_NATIONAL(ZOMBIDUCK),
    HOENN_TO_NATIONAL(HELLDUCK),
    HOENN_TO_NATIONAL(POTDUCK),
    HOENN_TO_NATIONAL(WEEDUCK),
    HOENN_TO_NATIONAL(BAKEDUCK),
    HOENN_TO_NATIONAL(GOLDDUCK),
    HOENN_TO_NATIONAL(TOXIDUCK),
    HOENN_TO_NATIONAL(TETRIDUCK),
    HOENN_TO_NATIONAL(VERT),
    HOENN_TO_NATIONAL(DUCKBOXV1),
    HOENN_TO_NATIONAL(DUCKBOXV2),
    HOENN_TO_NATIONAL(DUCKBOXV3),
    HOENN_TO_NATIONAL(DUCKBOXV4),
    HOENN_TO_NATIONAL(DUCKBOXV5),
    HOENN_TO_NATIONAL(BUBCARL),
    HOENN_TO_NATIONAL(BUBBERDUCK),
    HOENN_TO_NATIONAL(ULTRABDUCK),
    HOENN_TO_NATIONAL(DUCKROLL),
    HOENN_TO_NATIONAL(FARFETCHD_GALAR),
    HOENN_TO_NATIONAL(SIRFETCHD),
    HOENN_TO_NATIONAL(DUCKLES),
    HOENN_TO_NATIONAL(DUCKBOXGANG),
    HOENN_TO_NATIONAL(DUCKBOT666),
    HOENN_TO_NATIONAL(MARC),
    HOENN_TO_NATIONAL(BIGDUCKUS),
    HOENN_TO_NATIONAL(BUTTONBARI),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_LEAFDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LEAFDUCK2 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LEAFDUCK3 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLAMEDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLAMEINGO - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_XENOPH - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WATERDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WATERDUCK2 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WATERDUCK3 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GLASSEDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_3DUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_SUNDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DAGGERDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SWORDUCK - 1] = ANIM_V_STRETCH,
    [SPECIES_PINGEDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOKUDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SANDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MONODUCK - 1] = ANIM_GLOW_BLACK,
    [SPECIES_PETERDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_INVERTDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PENGUIDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DEADUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCKROLL - 1] = ANIM_V_JUMPS_SMALL,
    [SPECIES_AVALUGG - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCCAR - 1] = ANIM_V_JUMPS_SMALL,
    [SPECIES_BEEDUCK - 1] = ANIM_FIGURE_8,
    [SPECIES_GHOSTEDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLYINGDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLYDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ZOMBIDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HELLDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_POTDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WEEDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BAKEDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOLDDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOXIDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TETRIDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VERT - 1] = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_DUCKBOXV1 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCKBOXV2 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCKBOXV3 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCKBOXV4 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCKBOXV5 - 1] = ANIM_V_SHAKE,
    [SPECIES_BUBCARL - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BUBBERDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ULTRABDUCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUCKLES - 1] = ANIM_H_VIBRATE,
    [SPECIES_DUCKBOXGANG - 1] = ANIM_TUMBLING_FRONT_FLIP_TWICE,
    [SPECIES_DUCKBOT666 - 1] = ANIM_V_SHAKE_TWICE,
    [SPECIES_MARC - 1] = ANIM_V_SLIDE,
    [SPECIES_BIGDUCKUS - 1] = ANIM_SWING_CONCAVE,
    [SPECIES_BUTTONBARI - 1] = ANIM_H_VIBRATE,
    [SPECIES_FARFETCHD_GALAR - 1]   = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_SIRFETCHD - 1]   = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    // Physical-special split: Weather outside of Special check
