...
// begin tm type icons region
// credit to https://github.com/rh-hideout/pokeemerald-expansion/pull/1254/files
...
static void PrintTMHMMoveData(u16 itemId)
{
    ...
    else
    {
        ...
        //        BlitMenuInfoIcon(WIN_TMHM_INFO, gBattleMoves[moveId].type + 1, 0, 0); draws FR type icon
