...
static const u16 sNaturePowerMoves[] =
{
    ...
    [BATTLE_TERRAIN_SPACE]      = MOVE_DRAGON_RAGE, // TODO: Draco Meteor
    [BATTLE_TERRAIN_ULTRA]      = MOVE_PSYCHIC, // TODO: Psyshock 
};
...
static const u8 sTerrainToType[] =
{
    ...
    [BATTLE_TERRAIN_ULTRA]      = TYPE_PSYCHIC,
};
...
static void Cmd_critcalc(void)
{
    ...
    critChance  = 2 * ((gBattleMons[gBattlerAttacker].status2 & STATUS2_FOCUS_ENERGY) != 0)
                ...
                + (gBattleMoves[gCurrentMove].effect == EFFECT_ASTRAL_BLADE)
                + (holdEffect == HOLD_EFFECT_SCOPE_LENS)
                + 2 * (holdEffect == HOLD_EFFECT_LUCKY_PUNCH && gBattleMons[gBattlerAttacker].species == SPECIES_CHANSEY)
                + 2 * (holdEffect == HOLD_EFFECT_STICK && (gBattleMons[gBattlerAttacker].species == SPECIES_FARFETCHD || gBattleMons[gBattlerAttacker].species == SPECIES_FARFETCHD_GALAR || gBattleMons[gBattlerAttacker].species == SPECIES_SIRFETCHD));
    ...
    if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
    {
        ...
        else
        {
            ...
            else // hp goes down
            {
                ...
                else if (IS_TYPE_SPECIAL(gBattleMoves[gCurrentMove]) && !(gHitMarker & HITMARKER_PASSIVE_DAMAGE))
                {
...
static void RecalcBattlerStats(u32 battler, struct Pokemon *mon) //from battle engine
{
