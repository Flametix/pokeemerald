static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DEMO - 1] = {MAP_GROUP(DEMO_CHRISTMAS_DUCKS), MAP_NUM(DEMO_CHRISTMAS_DUCKS), 10, 3},
    [HEAL_LOCATION_MOON_TOWN - 1] = {MAP_GROUP(MOON_TOWN), MAP_NUM(MOON_TOWN), 7, 10},
    [HEAL_LOCATION_STUDIOS_CITY - 1] = {MAP_GROUP(STUDIOS_CITY), MAP_NUM(STUDIOS_CITY), 18, 12},
};
