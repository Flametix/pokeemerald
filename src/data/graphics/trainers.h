...
const u32 gTrainerFrontPic_XmasDucks[] = INCBIN_U32("graphics/trainers/front_pics/xmas_ducks_front_pic.4bpp.lz");
const u32 gTrainerPalette_XmasDucks[] = INCBIN_U32("graphics/trainers/palettes/xmas_ducks.gbapal.lz");
