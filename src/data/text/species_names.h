const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_LEAFDUCK] = _("Leafduck"),
    [SPECIES_LEAFDUCK2] = _("Barrafrond"),
    [SPECIES_LEAFDUCK3] = _("Leafduck3"),
    [SPECIES_FLAMEDUCK] = _("Flameduck"),
    [SPECIES_FLAMEINGO] = _("Flameingo"),
    [SPECIES_XENOPH] = _("Xenoph"),
    [SPECIES_WATERDUCK] = _("Waterduck"),
    [SPECIES_WATERDUCK2] = _("Waterduck2"),
    [SPECIES_WATERDUCK3] = _("Waterduck3"),
    [SPECIES_GLASSEDUCK] = _("Glasseduck"),
    [SPECIES_3DUCK] = _("3Duck"),
    [SPECIES_SUNDUCK] = _("Sunduck"),
    [SPECIES_DAGGERDUCK] = _("Daggerduck"),
    [SPECIES_SWORDUCK] = _("Sworduck"),
    [SPECIES_PINGEDUCK] = _("Pingeduck"),
    [SPECIES_GOKUDUCK] = _("Gokuduck"),
    [SPECIES_SANDUCK] = _("Sanduck"),
    [SPECIES_MONODUCK] = _("Monoduck"),
    [SPECIES_PETERDUCK] = _("Peterduck"),
    [SPECIES_INVERTDUCK] = _("Invertduck"),
    [SPECIES_PENGUIDUCK] = _("Penguiduck"),
    [SPECIES_DEADUCK] = _("Deaduck"),
    [SPECIES_DUCCAR] = _("Duccar"),
    [SPECIES_BEEDUCK] = _("Beeduck"),
    [SPECIES_GHOSTEDUCK] = _("Ghosteduck"),
    [SPECIES_FLYINGDUCK] = _("Flyduck"),
    [SPECIES_FLYDUCK] = _("Fly Duck"),
    [SPECIES_ZOMBIDUCK] = _("Zombiduck"),
    [SPECIES_HELLDUCK] = _("Hellduck"),
    [SPECIES_POTDUCK] = _("Potduck"),
    [SPECIES_WEEDUCK] = _("Weeduck"),
    [SPECIES_BAKEDUCK] = _("Bakeduck"),
    [SPECIES_GOLDDUCK] = _("Goldduck"),
    [SPECIES_TOXIDUCK] = _("Toxiduck"),
    [SPECIES_TETRIDUCK] = _("Tetriduck"),
    [SPECIES_VERT] = _("Vert"),
    [SPECIES_DUCKBOXV1] = _("DuckBoxV1"),
    [SPECIES_DUCKBOXV2] = _("DuckBoxV2"),
    [SPECIES_DUCKBOXV3] = _("DuckBoxV3"),
    [SPECIES_DUCKBOXV4] = _("DuckBoxV4"),
    [SPECIES_DUCKBOXV5] = _("DuckBoxV5"),
    [SPECIES_BUBCARL] = _("Bubcarl"),
    [SPECIES_BUBBERDUCK] = _("Bubberduck"),
    [SPECIES_ULTRABDUCK] = _("UltraBduck"),
    [SPECIES_DUCKLES] = _("Duckles"),
    [SPECIES_MARC] = _("marc"),
    [SPECIES_BIGDUCKUS] = _("big duckus"),
    [SPECIES_BUTTONBARI] = _("ButtonBari"),
