const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(WATERDUCK, gMonBackPic_Waterduck),
    SPECIES_SPRITE(WATERDUCK2, gMonBackPic_Waterduck2),
    SPECIES_SPRITE(WATERDUCK3, gMonBackPic_Waterduck3),
    SPECIES_SPRITE(GLASSEDUCK, gMonBackPic_Glasseduck),
    SPECIES_SPRITE(3DUCK, gMonBackPic_3Duck),
    SPECIES_SPRITE(SUNDUCK, gMonBackPic_Sunduck),
    SPECIES_SPRITE(DAGGERDUCK, gMonBackPic_Daggerduck),
    SPECIES_SPRITE(SWORDUCK, gMonBackPic_Sworduck),
    SPECIES_SPRITE(PINGEDUCK, gMonBackPic_Pingeduck),
    SPECIES_SPRITE(GOKUDUCK, gMonBackPic_Gokuduck),
    SPECIES_SPRITE(SANDUCK, gMonBackPic_Sanduck),
    SPECIES_SPRITE(MONODUCK, gMonBackPic_Monoduck),
    SPECIES_SPRITE(PETERDUCK, gMonBackPic_Peterduck),
    SPECIES_SPRITE(INVERTDUCK, gMonBackPic_Invertduck),
    SPECIES_SPRITE(PENGUIDUCK, gMonBackPic_Penguiduck),
    SPECIES_SPRITE(DEADUCK, gMonBackPic_Deaduck),
    SPECIES_SPRITE(DUCCAR, gMonBackPic_Duccar),
    SPECIES_SPRITE(BEEDUCK, gMonBackPic_Beeduck),
    SPECIES_SPRITE(GHOSTEDUCK, gMonBackPic_Ghosteduck),
    SPECIES_SPRITE(FLYINGDUCK, gMonBackPic_Flyingduck),
    SPECIES_SPRITE(FLYDUCK, gMonBackPic_FlyDuck),
    SPECIES_SPRITE(ZOMBIDUCK, gMonBackPic_Zombiduck),
    SPECIES_SPRITE(HELLDUCK, gMonBackPic_Hellduck),
    SPECIES_SPRITE(POTDUCK, gMonBackPic_Potduck),
    SPECIES_SPRITE(WEEDUCK, gMonBackPic_Weeduck),
    SPECIES_SPRITE(BAKEDUCK, gMonBackPic_Bakeduck),
    SPECIES_SPRITE(GOLDDUCK, gMonBackPic_Goldduck),
    SPECIES_SPRITE(TOXIDUCK, gMonBackPic_Toxiduck),
    SPECIES_SPRITE(TETRIDUCK, gMonBackPic_Tetriduck),
    SPECIES_SPRITE(VERT, gMonBackPic_Vert),
    SPECIES_SPRITE(DUCKBOXV1, gMonBackPic_DuckBoxV1),
    SPECIES_SPRITE(DUCKBOXV2, gMonBackPic_DuckBoxV2),
    SPECIES_SPRITE(DUCKBOXV3, gMonBackPic_DuckBoxV3),
    SPECIES_SPRITE(DUCKBOXV4, gMonBackPic_DuckBoxV4),
    SPECIES_SPRITE(DUCKBOXV5, gMonBackPic_DuckBoxV5),
    SPECIES_SPRITE(BUBCARL, gMonBackPic_Bubcarl),
    SPECIES_SPRITE(BUBBERDUCK, gMonBackPic_Bubberduck),
    SPECIES_SPRITE(ULTRABDUCK, gMonBackPic_UltraBubberduck),
    SPECIES_SPRITE(DUCKLES, gMonBackPic_Duckles),
    SPECIES_SPRITE(DUCKBOXGANG, gMonBackPic_DuckboxGang),
    SPECIES_SPRITE(DUCKBOT666, gMonBackPic_DuckBot666),
    SPECIES_SPRITE(MARC, gMonBackPic_Marc),
    SPECIES_SPRITE(BIGDUCKUS, gMonBackPic_BigDuckus),
    SPECIES_SPRITE(BUTTONBARI, gMonBackPic_ButtonBari),
    SPECIES_SPRITE(DUCKROLL, gMonBackPic_Duckroll),
    SPECIES_SPRITE(FARFETCHD_GALAR, gMonBackPic_FarfetchdGalar),
