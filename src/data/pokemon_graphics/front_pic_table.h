const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(LEAFDUCK, gMonFrontPic_Leafduck),
    SPECIES_SPRITE(LEAFDUCK2, gMonFrontPic_Leafduck2),
    SPECIES_SPRITE(LEAFDUCK3, gMonFrontPic_Leafduck3),
    SPECIES_SPRITE(FLAMEDUCK, gMonFrontPic_Flameduck),
    SPECIES_SPRITE(FLAMEINGO, gMonFrontPic_Flameingo),
    SPECIES_SPRITE(XENOPH, gMonFrontPic_Xenoph),
    SPECIES_SPRITE(WATERDUCK, gMonFrontPic_Waterduck),
    SPECIES_SPRITE(WATERDUCK2, gMonFrontPic_Waterduck2),
    SPECIES_SPRITE(WATERDUCK3, gMonFrontPic_Waterduck3),
    SPECIES_SPRITE(GLASSEDUCK, gMonFrontPic_Glasseduck),
    SPECIES_SPRITE(3DUCK, gMonFrontPic_3Duck),
    SPECIES_SPRITE(SUNDUCK, gMonFrontPic_Sunduck),
    SPECIES_SPRITE(DAGGERDUCK, gMonFrontPic_Daggerduck),
    SPECIES_SPRITE(SWORDUCK, gMonFrontPic_Sworduck),
    SPECIES_SPRITE(PINGEDUCK, gMonFrontPic_Pingeduck),
    SPECIES_SPRITE(GOKUDUCK, gMonFrontPic_Gokuduck),
    SPECIES_SPRITE(SANDUCK, gMonFrontPic_Sanduck),
    SPECIES_SPRITE(MONODUCK, gMonFrontPic_Monoduck),
    SPECIES_SPRITE(PETERDUCK, gMonFrontPic_Peterduck),
    SPECIES_SPRITE(INVERTDUCK, gMonFrontPic_Invertduck),
    SPECIES_SPRITE(PENGUIDUCK, gMonFrontPic_Penguiduck),
    SPECIES_SPRITE(DEADUCK, gMonFrontPic_Deaduck),
    SPECIES_SPRITE(DUCCAR, gMonFrontPic_Duccar),
    SPECIES_SPRITE(BEEDUCK, gMonFrontPic_Beeduck),
    SPECIES_SPRITE(GHOSTEDUCK, gMonFrontPic_Ghosteduck),
    SPECIES_SPRITE(FLYINGDUCK, gMonFrontPic_Flyingduck),
    SPECIES_SPRITE(FLYDUCK, gMonFrontPic_FlyDuck),
    SPECIES_SPRITE(ZOMBIDUCK, gMonFrontPic_Zombiduck),
    SPECIES_SPRITE(HELLDUCK, gMonFrontPic_Hellduck),
    SPECIES_SPRITE(POTDUCK, gMonFrontPic_Potduck),
    SPECIES_SPRITE(WEEDUCK, gMonFrontPic_Weeduck),
    SPECIES_SPRITE(BAKEDUCK, gMonFrontPic_Bakeduck),
    SPECIES_SPRITE(GOLDDUCK, gMonFrontPic_Goldduck),
    SPECIES_SPRITE(TOXIDUCK, gMonFrontPic_Toxiduck),
    SPECIES_SPRITE(TETRIDUCK, gMonFrontPic_Tetriduck),
    SPECIES_SPRITE(VERT, gMonFrontPic_Vert),
    SPECIES_SPRITE(DUCKBOXV1, gMonFrontPic_DuckBoxV1),
    SPECIES_SPRITE(DUCKBOXV2, gMonFrontPic_DuckBoxV2),
    SPECIES_SPRITE(DUCKBOXV3, gMonFrontPic_DuckBoxV3),
    SPECIES_SPRITE(DUCKBOXV4, gMonFrontPic_DuckBoxV4),
    SPECIES_SPRITE(DUCKBOXV5, gMonFrontPic_DuckBoxV5),
    SPECIES_SPRITE(BUBCARL, gMonFrontPic_Bubcarl),
    SPECIES_SPRITE(BUBBERDUCK, gMonFrontPic_Bubberduck),
    SPECIES_SPRITE(ULTRABDUCK, gMonFrontPic_UltraBubberduck),
    SPECIES_SPRITE(DUCKLES, gMonFrontPic_Duckles),
    SPECIES_SPRITE(DUCKBOXGANG, gMonFrontPic_DuckboxGang),
    SPECIES_SPRITE(DUCKBOT666, gMonFrontPic_DuckBot666),
    SPECIES_SPRITE(MARC, gMonFrontPic_Marc),
    SPECIES_SPRITE(BIGDUCKUS, gMonFrontPic_BigDuckus),
    SPECIES_SPRITE(BUTTONBARI, gMonFrontPic_ButtonBari),
    SPECIES_SPRITE(DUCKROLL, gMonFrontPic_Duckroll),
    SPECIES_SPRITE(FARFETCHD_GALAR, gMonFrontPic_FarfetchdGalar),
    SPECIES_SPRITE(SIRFETCHD, gMonFrontSprite_Sirfetchd),
