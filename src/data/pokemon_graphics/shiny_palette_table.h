const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(LEAFDUCK, gMonShinyPalette_Leafduck),
    SPECIES_SHINY_PAL(LEAFDUCK2, gMonShinyPalette_Leafduck2),
    SPECIES_SHINY_PAL(LEAFDUCK3, gMonShinyPalette_Leafduck3),
    SPECIES_SHINY_PAL(FLAMEDUCK, gMonShinyPalette_Flameduck),
    SPECIES_SHINY_PAL(FLAMEINGO, gMonShinyPalette_Flameingo),
    SPECIES_SHINY_PAL(XENOPH, gMonShinyPalette_Xenoph),
    SPECIES_SHINY_PAL(WATERDUCK, gMonShinyPalette_Waterduck),
    SPECIES_SHINY_PAL(WATERDUCK2, gMonShinyPalette_Waterduck2),
    SPECIES_SHINY_PAL(WATERDUCK3, gMonShinyPalette_Waterduck3),
    SPECIES_SHINY_PAL(GLASSEDUCK, gMonShinyPalette_Glasseduck),
    SPECIES_SHINY_PAL(3DUCK, gMonShinyPalette_3Duck),
    SPECIES_SHINY_PAL(SUNDUCK, gMonShinyPalette_Sunduck),
    SPECIES_SHINY_PAL(DAGGERDUCK, gMonShinyPalette_Daggerduck),
    SPECIES_SHINY_PAL(SWORDUCK, gMonShinyPalette_Sworduck),
    SPECIES_SHINY_PAL(PINGEDUCK, gMonShinyPalette_Pingeduck),
    SPECIES_SHINY_PAL(GOKUDUCK, gMonShinyPalette_Gokuduck),
    SPECIES_SHINY_PAL(SANDUCK, gMonShinyPalette_Sanduck),
    SPECIES_SHINY_PAL(MONODUCK, gMonShinyPalette_Monoduck),
    SPECIES_SHINY_PAL(PETERDUCK, gMonShinyPalette_Peterduck),
    SPECIES_SHINY_PAL(INVERTDUCK, gMonShinyPalette_Invertduck),
    SPECIES_SHINY_PAL(PENGUIDUCK, gMonShinyPalette_Penguiduck),
    SPECIES_SHINY_PAL(DEADUCK, gMonShinyPalette_Deaduck),
    SPECIES_SHINY_PAL(DUCCAR, gMonShinyPalette_Duccar),
    SPECIES_SHINY_PAL(BEEDUCK, gMonShinyPalette_Beeduck),
    SPECIES_SHINY_PAL(GHOSTEDUCK, gMonShinyPalette_Ghosteduck),
    SPECIES_SHINY_PAL(FLYINGDUCK, gMonShinyPalette_Flyingduck),
    SPECIES_SHINY_PAL(FLYDUCK, gMonShinyPalette_FlyDuck),
    SPECIES_SHINY_PAL(ZOMBIDUCK, gMonShinyPalette_Zombiduck),
    SPECIES_SHINY_PAL(HELLDUCK, gMonShinyPalette_Hellduck),
    SPECIES_SHINY_PAL(POTDUCK, gMonShinyPalette_Potduck),
    SPECIES_SHINY_PAL(WEEDUCK, gMonShinyPalette_Weeduck),
    SPECIES_SHINY_PAL(BAKEDUCK, gMonShinyPalette_Bakeduck),
    SPECIES_SHINY_PAL(GOLDDUCK, gMonShinyPalette_Goldduck),
    SPECIES_SHINY_PAL(TOXIDUCK, gMonShinyPalette_Toxiduck),
    SPECIES_SHINY_PAL(TETRIDUCK, gMonShinyPalette_Tetriduck),
    SPECIES_SHINY_PAL(VERT, gMonShinyPalette_Vert),
    SPECIES_SHINY_PAL(DUCKBOXV1, gMonShinyPalette_DuckBoxV1),
    SPECIES_SHINY_PAL(DUCKBOXV2, gMonShinyPalette_DuckBoxV2),
    SPECIES_SHINY_PAL(DUCKBOXV3, gMonShinyPalette_DuckBoxV3),
    SPECIES_SHINY_PAL(DUCKBOXV4, gMonShinyPalette_DuckBoxV4),
    SPECIES_SHINY_PAL(DUCKBOXV5, gMonShinyPalette_DuckBoxV5),
    SPECIES_SHINY_PAL(BUBCARL, gMonShinyPalette_Bubcarl),
    SPECIES_SHINY_PAL(BUBBERDUCK, gMonShinyPalette_Bubberduck),
    SPECIES_SHINY_PAL(ULTRABDUCK, gMonShinyPalette_UltraBubberduck),
    SPECIES_SHINY_PAL(DUCKLES, gMonShinyPalette_Duckles),
    SPECIES_SHINY_PAL(DUCKBOXGANG, gMonShinyPalette_DuckboxGang),
    SPECIES_SHINY_PAL(DUCKBOT666, gMonShinyPalette_DuckBot666),
    SPECIES_SHINY_PAL(MARC, gMonShinyPalette_Marc),
    SPECIES_SHINY_PAL(BIGDUCKUS, gMonShinyPalette_BigDuckus),
    SPECIES_SHINY_PAL(BUTTONBARI, gMonShinyPalette_ButtonBari),
    SPECIES_SHINY_PAL(DUCKROLL, gMonShinyPalette_Duckroll),
    SPECIES_SHINY_PAL(FARFETCHD_GALAR, gMonShinyPalette_FarfetchdGalar),
