const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_GRASSDUCK] = gMonFootprint_Grassduck,
    [SPECIES_GRASSDUCK2] = gMonFootprint_Grassduck2,
    [SPECIES_GRASSDUCK3] = gMonFootprint_Grassduck3,
    [SPECIES_FLAMEDUCK] = gMonFootprint_Flameduck,
    [SPECIES_FLAMEINGO] = gMonFootprint_Flameingo,
    [SPECIES_XENOPH] = gMonFootprint_Xenoph,
    [SPECIES_WATERDUCK] = gMonFootprint_Waterduck,
    [SPECIES_WATERDUCK2] = gMonFootprint_Waterduck2,
    [SPECIES_WATERDUCK3] = gMonFootprint_Waterduck3,
    [SPECIES_GLASSEDUCK] = gMonFootprint_Glasseduck,
    [SPECIES_3DUCK] = gMonFootprint_3Duck,
    [SPECIES_SUNDUCK] = gMonFootprint_Sunduck,
    [SPECIES_DAGGERDUCK] = gMonFootprint_Daggerduck,
    [SPECIES_SWORDUCK] = gMonFootprint_Sworduck,
    [SPECIES_PINGEDUCK] = gMonFootprint_Pingeduck,
    [SPECIES_GOKUDUCK] = gMonFootprint_Gokuduck,
    [SPECIES_SANDUCK] = gMonFootprint_Sanduck,
    [SPECIES_MONODUCK] = gMonFootprint_Monoduck,
    [SPECIES_PETERDUCK] = gMonFootprint_Peterduck,
    [SPECIES_INVERTDUCK] = gMonFootprint_Invertduck,
    [SPECIES_PENGUIDUCK] = gMonFootprint_Penguiduck,
    [SPECIES_DEADUCK] = gMonFootprint_Deaduck,
    [SPECIES_DUCCAR] = gMonFootprint_Duccar,
    [SPECIES_BEEDUCK] = gMonFootprint_Beeduck,
    [SPECIES_GHOSTEDUCK] = gMonFootprint_Ghosteduck,
    [SPECIES_FLYINGDUCK] = gMonFootprint_Flyingduck,
    [SPECIES_FLYDUCK] = gMonFootprint_FlyDuck,
    [SPECIES_ZOMBIDUCK] = gMonFootprint_Zombiduck,
    [SPECIES_HELLDUCK] = gMonFootprint_Hellduck,
    [SPECIES_POTDUCK] = gMonFootprint_Potduck,
    [SPECIES_WEEDUCK] = gMonFootprint_Weeduck,
    [SPECIES_BAKEDUCK] = gMonFootprint_Bakeduck,
    [SPECIES_GOLDDUCK] = gMonFootprint_Goldduck,
    [SPECIES_TOXIDUCK] = gMonFootprint_Toxiduck,
    [SPECIES_TETRIDUCK] = gMonFootprint_Tetriduck,
    [SPECIES_VERT] = gMonFootprint_Vert,
    [SPECIES_DUCKBOXV1] = gMonFootprint_DuckBoxV1,
    [SPECIES_DUCKBOXV2] = gMonFootprint_DuckBoxV2,
    [SPECIES_DUCKBOXV3] = gMonFootprint_DuckBoxV3,
    [SPECIES_DUCKBOXV4] = gMonFootprint_DuckBoxV4,
    [SPECIES_DUCKBOXV5] = gMonFootprint_DuckBoxV5,
