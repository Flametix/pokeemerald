...
SINGLE_ANIMATION(LEAFDUCK);
SINGLE_ANIMATION(LEAFDUCK2);
SINGLE_ANIMATION(LEAFDUCK3);
SINGLE_ANIMATION(FLAMEDUCK);
SINGLE_ANIMATION(FLAMEINGO);
SINGLE_ANIMATION(XENOPH);
SINGLE_ANIMATION(WATERDUCK);
SINGLE_ANIMATION(WATERDUCK2);
SINGLE_ANIMATION(WATERDUCK3);
SINGLE_ANIMATION(GLASSEDUCK);
SINGLE_ANIMATION(3DUCK);
SINGLE_ANIMATION(SUNDUCK);
SINGLE_ANIMATION(DAGGERDUCK);
SINGLE_ANIMATION(SWORDUCK);
SINGLE_ANIMATION(PINGEDUCK);
SINGLE_ANIMATION(GOKUDUCK);
SINGLE_ANIMATION(SANDUCK);
SINGLE_ANIMATION(MONODUCK);
SINGLE_ANIMATION(PETERDUCK);
SINGLE_ANIMATION(INVERTDUCK);
SINGLE_ANIMATION(PENGUIDUCK);
SINGLE_ANIMATION(DEADUCK);
SINGLE_ANIMATION(DUCCAR);
SINGLE_ANIMATION(BEEDUCK);
SINGLE_ANIMATION(GHOSTEDUCK);
SINGLE_ANIMATION(FLYINGDUCK);
SINGLE_ANIMATION(FLYDUCK);
SINGLE_ANIMATION(ZOMBIDUCK);
SINGLE_ANIMATION(HELLDUCK);
SINGLE_ANIMATION(POTDUCK);
SINGLE_ANIMATION(WEEDUCK);
SINGLE_ANIMATION(BAKEDUCK);
SINGLE_ANIMATION(GOLDDUCK);
SINGLE_ANIMATION(TOXIDUCK);
SINGLE_ANIMATION(TETRIDUCK);
SINGLE_ANIMATION(VERT);
SINGLE_ANIMATION(DUCKBOXV1);
SINGLE_ANIMATION(DUCKBOXV2);
SINGLE_ANIMATION(DUCKBOXV3);
SINGLE_ANIMATION(DUCKBOXV4);
SINGLE_ANIMATION(DUCKBOXV5);
SINGLE_ANIMATION(BUBCARL);
SINGLE_ANIMATION(BUBBERDUCK);
SINGLE_ANIMATION(ULTRABDUCK);
SINGLE_ANIMATION(DUCKLES);
SINGLE_ANIMATION(DUCKBOXGANG);
SINGLE_ANIMATION(DUCKBOT666);
SINGLE_ANIMATION(MARC);
SINGLE_ANIMATION(BIGDUCKUS);
SINGLE_ANIMATION(BUTTONBARI);
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_LEAFDUCK] = sAnims_LEAFDUCK,
    [SPECIES_LEAFDUCK2] = sAnims_LEAFDUCK2,
    [SPECIES_LEAFDUCK3] = sAnims_LEAFDUCK3,
    [SPECIES_FLAMEDUCK] = sAnims_FLAMEDUCK,
    [SPECIES_FLAMEINGO] = sAnims_FLAMEINGO,
    [SPECIES_XENOPH] = sAnims_XENOPH,
    [SPECIES_WATERDUCK] = sAnims_WATERDUCK,
    [SPECIES_WATERDUCK2] = sAnims_WATERDUCK2,
    [SPECIES_WATERDUCK3] = sAnims_WATERDUCK3,
    [SPECIES_GLASSEDUCK] = sAnims_GLASSEDUCK,
    [SPECIES_3DUCK] = sAnims_3DUCK,
    [SPECIES_SUNDUCK] = sAnims_SUNDUCK,
    [SPECIES_DAGGERDUCK] = sAnims_DAGGERDUCK,
    [SPECIES_SWORDUCK] = sAnims_SWORDUCK,
    [SPECIES_PINGEDUCK] = sAnims_PINGEDUCK,
    [SPECIES_GOKUDUCK] = sAnims_GOKUDUCK,
    [SPECIES_SANDUCK] = sAnims_SANDUCK,
    [SPECIES_MONODUCK] = sAnims_MONODUCK,
    [SPECIES_PETERDUCK] = sAnims_PETERDUCK,
    [SPECIES_INVERTDUCK] = sAnims_INVERTDUCK,
    [SPECIES_PENGUIDUCK] = sAnims_PENGUIDUCK,
    [SPECIES_DEADUCK] = sAnims_DEADUCK,
    [SPECIES_DUCCAR] = sAnims_DUCCAR,
    [SPECIES_BEEDUCK] = sAnims_BEEDUCK,
    [SPECIES_GHOSTEDUCK] = sAnims_GHOSTEDUCK,
    [SPECIES_FLYINGDUCK] = sAnims_FLYINGDUCK,
    [SPECIES_FLYDUCK] = sAnims_FLYDUCK,
    [SPECIES_ZOMBIDUCK] = sAnims_ZOMBIDUCK,
    [SPECIES_HELLDUCK] = sAnims_HELLDUCK,
    [SPECIES_POTDUCK] = sAnims_POTDUCK,
    [SPECIES_WEEDUCK] = sAnims_WEEDUCK,
    [SPECIES_BAKEDUCK] = sAnims_BAKEDUCK,
    [SPECIES_GOLDDUCK] = sAnims_GOLDDUCK,
    [SPECIES_TOXIDUCK] = sAnims_TOXIDUCK,
    [SPECIES_TETRIDUCK] = sAnims_TETRIDUCK,
    [SPECIES_VERT] = sAnims_VERT,
    [SPECIES_DUCKBOXV1] = sAnims_DUCKBOXV1,
    [SPECIES_DUCKBOXV2] = sAnims_DUCKBOXV2,
    [SPECIES_DUCKBOXV3] = sAnims_DUCKBOXV3,
    [SPECIES_DUCKBOXV4] = sAnims_DUCKBOXV4,
    [SPECIES_DUCKBOXV5] = sAnims_DUCKBOXV5,
    [SPECIES_BUBCARL] = sAnims_BUBCARL,
    [SPECIES_BUBBERDUCK] = sAnims_BUBBERDUCK,
    [SPECIES_ULTRABDUCK] = sAnims_ULTRABDUCK,
    [SPECIES_DUCKLES] = sAnims_DUCKLES,
    [SPECIES_DUCKBOXGANG] = sAnims_DUCKBOXGANG,
    [SPECIES_DUCKBOT666] = sAnims_DUCKBOT666,
    [SPECIES_MARC] = sAnims_MARC,
