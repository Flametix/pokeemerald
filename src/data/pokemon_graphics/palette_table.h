const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(LEAFDUCK, gMonPalette_Leafduck),
    SPECIES_PAL(LEAFDUCK2, gMonPalette_Leafduck2),
    SPECIES_PAL(LEAFDUCK3, gMonPalette_Leafduck3),
    SPECIES_PAL(FLAMEDUCK, gMonPalette_Flameduck),
    SPECIES_PAL(FLAMEINGO, gMonPalette_Flameingo),
    SPECIES_PAL(XENOPH, gMonPalette_Xenoph),
    SPECIES_PAL(WATERDUCK, gMonPalette_Waterduck),
    SPECIES_PAL(WATERDUCK2, gMonPalette_Waterduck2),
    SPECIES_PAL(WATERDUCK3, gMonPalette_Waterduck3),
    SPECIES_PAL(GLASSEDUCK, gMonPalette_Glasseduck),
    SPECIES_PAL(3DUCK, gMonPalette_3Duck),
    SPECIES_PAL(SUNDUCK, gMonPalette_Sunduck),
    SPECIES_PAL(DAGGERDUCK, gMonPalette_Daggerduck),
    SPECIES_PAL(SWORDUCK, gMonPalette_Sworduck),
    SPECIES_PAL(PINGEDUCK, gMonPalette_Pingeduck),
    SPECIES_PAL(GOKUDUCK, gMonPalette_Gokuduck),
    SPECIES_PAL(SANDUCK, gMonPalette_Sanduck),
    SPECIES_PAL(MONODUCK, gMonPalette_Monoduck),
    SPECIES_PAL(PETERDUCK, gMonPalette_Peterduck),
    SPECIES_PAL(INVERTDUCK, gMonPalette_Invertduck),
    SPECIES_PAL(PENGUIDUCK, gMonPalette_Penguiduck),
    SPECIES_PAL(DEADUCK, gMonPalette_Deaduck),
    SPECIES_PAL(DUCCAR, gMonPalette_Duccar),
    SPECIES_PAL(BEEDUCK, gMonPalette_Beeduck),
    SPECIES_PAL(GHOSTEDUCK, gMonPalette_Ghosteduck),
    SPECIES_PAL(FLYINGDUCK, gMonPalette_Flyingduck),
    SPECIES_PAL(FLYDUCK, gMonPalette_FlyDuck),
    SPECIES_PAL(ZOMBIDUCK, gMonPalette_Zombiduck),
    SPECIES_PAL(HELLDUCK, gMonPalette_Hellduck),
    SPECIES_PAL(POTDUCK, gMonPalette_Potduck),
    SPECIES_PAL(WEEDUCK, gMonPalette_Weeduck),
    SPECIES_PAL(BAKEDUCK, gMonPalette_Bakeduck),
    SPECIES_PAL(GOLDDUCK, gMonPalette_Goldduck),
    SPECIES_PAL(TOXIDUCK, gMonPalette_Toxiduck),
    SPECIES_PAL(TETRIDUCK, gMonPalette_Tetriduck),
    SPECIES_PAL(VERT, gMonPalette_Vert),
    SPECIES_PAL(DUCKBOXV1, gMonPalette_DuckBoxV1),
    SPECIES_PAL(DUCKBOXV2, gMonPalette_DuckBoxV2),
    SPECIES_PAL(DUCKBOXV3, gMonPalette_DuckBoxV3),
    SPECIES_PAL(DUCKBOXV4, gMonPalette_DuckBoxV4),
    SPECIES_PAL(DUCKBOXV5, gMonPalette_DuckBoxV5),
    SPECIES_PAL(BUBCARL, gMonPalette_Bubcarl),
    SPECIES_PAL(BUBBERDUCK, gMonPalette_Bubberduck),
    SPECIES_PAL(ULTRABDUCK, gMonPalette_UltraBubberduck),
    SPECIES_PAL(DUCKLES, gMonPalette_Duckles),
    SPECIES_PAL(DUCKBOXGANG, gMonPalette_DuckboxGang),
    SPECIES_PAL(DUCKBOT666, gMonPalette_DuckBot666),
    SPECIES_PAL(MARC, gMonPalette_Marc),
    SPECIES_PAL(BIGDUCKUS, gMonPalette_BigDuckus),
    SPECIES_PAL(BUTTONBARI, gMonPalette_ButtonBari),
    SPECIES_PAL(DUCKROLL, gMonPalette_Duckroll),
    SPECIES_PAL(AVALUGG, gMonPalette_Avalugg),
    SPECIES_PAL(FARFETCHD_GALAR, gMonPalette_FarfetchdGalar),
