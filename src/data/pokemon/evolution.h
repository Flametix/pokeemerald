const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRASSDUCK]  = {{EVO_LEVEL, 16, SPECIES_GRASSDUCK2}},
    [SPECIES_GRASSDUCK2] = {{EVO_LEVEL, 32, SPECIES_GRASSDUCK3}},
    [SPECIES_FLAMEDUCK]  = {{EVO_LEVEL, 14, SPECIES_FLAMEINGO}},
    [SPECIES_FLAMEINGO]  = {{EVO_LEVEL, 36, SPECIES_XENOPH}},
    [SPECIES_WATERDUCK]  = {{EVO_LEVEL, 18, SPECIES_WATERDUCK2}},
    [SPECIES_WATERDUCK2] = {{EVO_LEVEL, 30, SPECIES_WATERDUCK3}},
};
