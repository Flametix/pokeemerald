const struct Trainer gTrainers[] = {
    ...
    [TRAINER_TIANA] =
    {
        ...
        .trainerName = _("TIANA"),
        .items = {ITEM_REVIVE, ITEM_MAX_REVIVE, ITEM_REVIVAL_HERB, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE,
    ...
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET,
        .trainerClass = TRAINER_CLASS_DEMO,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_YOUNGSTER,
        .trainerName = _("EST"),
        .items = {},
        ...
        .partySize = ARRAY_COUNT(sParty_TestTrainer),
        .party = {.ItemCustomMoves = sParty_TestTrainer},
    },
    [TRAINER_DEMO] =
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET,
        .trainerClass = TRAINER_CLASS_DEMO,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_XMAS_DUCKS,
        .trainerName = _("Xmas Ducks"),
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_HEAL, ITEM_FULL_HEAL},
        .doubleBattle = FALSE,
        ...
        .partySize = ARRAY_COUNT(sParty_DemoTrainer),
        .party = {.ItemCustomMoves = sParty_DemoTrainer},
    },
};
