...
static const u8 sDoorAnimTiles_DuckWorldStudios[] = INCBIN_U8("graphics/door_anims/studios.4bpp");
...
static const u8 sDoorAnimPalettes_DuckWorldStudios[] = {1, 1, 1, 1, 1, 1, 1, 1};
